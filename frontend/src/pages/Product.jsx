...
const Product = () => {
  ...
  return productData ? (
    <div className='border-t border-gray-300 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      {/* Product Data */}
      <div className='flex flex-col gapy-12 sm:gap-12  sm:flex-row'>
        {/* Product Images */}
            ...
            <div className='flex gap-2'>
              {
                productData.sizes.map((item, index) => (
                  <button onClick={() => setSize(item)} key={index} className={`border border-gray-300  py-2 px-4 bg-gray-100 ${item === size ? 'bg-orange-500' : ''}`}>{item}</button>
                ))
              }
            </div>
          </div>
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border border-gray-300 px-6 py-6 text-sm text-gray-500 mt-2'>
          <p>
            This product is crafted with high-quality materials to ensure durability and comfort.
            Its modern design makes it suitable for both casual and formal occasions.
          </p>
          <p>
            This product is crafted with high-quality materials to ensure durability and comfort.
            Its modern design makes it suitable for both casual and formal occasions.
